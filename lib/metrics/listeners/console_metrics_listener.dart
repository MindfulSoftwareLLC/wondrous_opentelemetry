...
class ConsoleMetricsListener {
  ...
  void _initializeTrackers() {
    _pageTracker = GetIt.I.get<PageTracker>();
    _paintTracker = GetIt.I.get<PaintTracker>();
    _shiftTracker = GetIt.I.get<ShiftTracker>();
    _apdexTracker = GetIt.I.get<ApdexTracker>();
    _userInputTracker = GetIt.I.get<UserInputTracker>();
    _errorTracker = GetIt.I.get<ErrorTracker>();
  }
